...
// Declare CmaServlet that responds to "/cma" paths
@WebServlet(name = "CmaServlet", value = "/cma")
public class CmaServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<GeographicArea> geographicAreas = dao.getGeographicAreaByLevel(loginBean, 2);
        ...
        request.getRequestDispatcher("cma.jsp").forward(request, response);
    }
