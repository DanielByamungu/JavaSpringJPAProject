...
// Declare ProvincialPartServlet that responds to "/provincial" paths
@WebServlet(name = "ProvincialPartServlet", value = "/provincial")
public class ProvincialPartServlet extends HttpServlet{
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<GeographicArea> geographicAreas = dao.getGeographicAreaByLevel(loginBean, 3);
        ...
        request.getRequestDispatcher("provincial.jsp").forward(request, response);
    }
