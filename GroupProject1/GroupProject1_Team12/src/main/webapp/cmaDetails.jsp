...
<div class="card">
    <div class="card-title">Census Metropolitan Area's (CMA) or Census Agglomeration's (CA) Details</div>
    ...
    <button class="button">
        ...
        <span class="button-text"><a href="<%= request.getContextPath()%>/cma">Back</a></span>
    </button>
</div>
