...
<div style="text-align: center">
    <div class="container">
        <h1>Census metropolitan areas (CMA) and census agglomerations (CA)</h1>
        <table>
            <thead>
            <tr>
                <th>Level</th>
            ...
            <tr>
                <td><%=area.getLevel()%></td>
                <td><%=area.getName()%></td>
                <td><a href="<%= request.getContextPath()%>/cmaDetails/<%= area.getGeographicAreaID()%>" style="color:blue; font-weight: normal;">Details</a></td>
            </tr>
            <% } %>
            </tbody>
        </table>
